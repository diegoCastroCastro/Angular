...
public class Inventario implements Serializable {
	 ...
	 * if(!this.inventarios.contains(inventario)){ this.inventarios.add(inventario);
	 * inventario.setProducto(this); } }
	 * 
	 * public void deleteInventario(Inventario inventario) { if
	 * (this.inventarios.contains(inventario)) {
	 * this.inventarios.remove(inventario); inventario.setProducto(null); } }
	 */
