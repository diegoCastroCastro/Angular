...
public class BodegaFacade extends AbstractFacade<Bodega> {
	...
	public int totalProductos(int codigo) {
		String jpql = "SELECT SUM(i.cantidad) FROM Inventario i INNER JOIN Bodega b ON b.codigo = i.bodega.codigo WHERE b.codigo = "
				+ codigo;

		// System.out.println("Dato de base... " +
	...
	public List<Bodega> findByName(String name) {
		// System.out.println("llego al metodo de
		// buscar...............................");
